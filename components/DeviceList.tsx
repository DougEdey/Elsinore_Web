...
import DeviceListQuery, {
  DeviceListQueryQueryData,
} from "./graphql/DeviceListQuery.graphql";
...
export default function DeviceList() {
  ...
  if (allControllers && allControllers.length) {
    const controllers = allControllers.map(
      (
        temperatureController: DeviceListQueryQueryData.TemperatureControllersTempProbeDetails
      ) => (
        <Device
